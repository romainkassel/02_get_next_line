...
/*   Updated: 2024/06/11 17:05:55 by rkassel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_next_line(int fd)
{
	...
	if (!residu)
		...
		global_buff = strcat_global_buff(global_buff, residu, -1);
	line_to_return = get_line_to_return(global_buff);
	residu = get_residu(global_buff, residu);
